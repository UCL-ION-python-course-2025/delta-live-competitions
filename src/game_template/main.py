...
def main() -> None:
    ...
    controller = CompetitionController(
        "", teams, GameTemplate, min_time_per_step=1, moves_per_state_change=1
    )
    tournament_view = TemplateTournament(controller)
