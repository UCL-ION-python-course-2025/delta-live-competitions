...
import delta_wild_tictactoe
from competition_controller import CompetitionController
from delta_wild_tictactoe.game_mechanics import load_dictionary
from play_competition import play_competition
from team import Team
from wild_tictactoe.game import WildTictactoeGame
from wild_tictactoe.visuals import WildTictactoeGameViewer

# makes e.g. "import game_mechanics" available to competitor code files
sys.path.append(delta_wild_tictactoe.__path__[0])  # isort:skip
